...
headers = data[0]  # Assume first row is the header
...
# Function to get score based on ID
def get_score(user_id):
    # Filter DataFrame to find the score corresponding to the user ID
    user_score = df[df['User ID'] == user_id]  # Assuming 'ID' is the name of the column
...
def handle_message(event):
    ...
    # Fetch the score from Google Sheets using the ID
